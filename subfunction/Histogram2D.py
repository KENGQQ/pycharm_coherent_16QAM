...
def Histogram2D_thesis(filename, data, Image_Address, SNR=0, EVM=0, BERcount= 0):
    ...
    fig.update_yaxes(range=[-4.2, 4.2],showticklabels=False)
    # fig.update_layout(
        # yaxis=dict(
        #     tickmode='array'
        #     # tickvals=[-3, -1, 1, 3],
    ...
    fig.update_xaxes(range=[-3.8,3.8],showticklabels=False)
    fig.update_xaxes(range=[-4.2, 4.2],showticklabels=False)
# fig.update_layout(
        # xaxis=dict(
        #     tickmode='array'
        #     # tickvals=[-3, -1, 1, 3],
